 ...
 */
package com.syncedsynapse.kore2.host;
...
public class HostConnectionObserver
    ...
    public interface PlayerEventsObserver {
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently playing item, obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetItem}
         */
         ...
         * @param getActivePlayerResult Active player obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetActivePlayers}
         * @param getPropertiesResult Properties obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetProperties}
         * @param getItemResult Currently paused item, obtained by a call to {@link com.syncedsynapse.kore2.jsonrpc.method.Player.GetItem}
         */
...
//        observerHandlerMap.remove(observer);
     ...
     */
    public void onPlay(com.syncedsynapse.kore2.jsonrpc.notification.Player.OnPlay notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onPause(com.syncedsynapse.kore2.jsonrpc.notification.Player.OnPause
                                notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSpeedChanged(com.syncedsynapse.kore2.jsonrpc.notification.Player
                                       .OnSpeedChanged notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onSeek(com.syncedsynapse.kore2.jsonrpc.notification.Player.OnSeek notification) {
        // Just start our chain calls
        chainCallGetActivePlayers();
    }

    public void onStop(com.syncedsynapse.kore2.jsonrpc.notification.Player.OnStop notification) {
        // Just start our chain calls
